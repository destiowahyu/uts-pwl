...
<html>
    ...
    <body style="background:#eaeaea;">
		<div class="container">
			<br/>
            <span style="color:#292929";>Selamat Datang, <?php echo $sesi['nama_pengguna'];?></span>
			<div class="float-right">	
				<a href="daftaruser.php" class="btn btn-success btn-md" style="margin-right:1pc;"><span class="fa fa-home"></span> Kembali</a> 
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="card">
						...
						<h4 class="card-title">Edit User - <?php echo $hasil['nama_pengguna'];?></h4>
						</div>
						<div class="card-body">
						...
						dengan method post ke proses crud dengan paramater get aksi edit -->
							<form action="proses/crud.php?aksi=edit" method="POST">
								...
								<div class="form-group">
									...
									<input type="text" value="<?php echo $hasil['peran'];?>" class="form-control" name="peran">
								</div>
