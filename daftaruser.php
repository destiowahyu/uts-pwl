			...
			<div class="row">
				<div class="col-lg-12">
                    ...
                    <div class="float-right">	
				        <a href="tabel/index.php" class="btn btn-success btn-md" style="margin-right:1pc;">Data Barang</a> 
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="tambah.php" class="btn btn-success btn-md"><span class="fa fa-plus"></span> Tambah User</a>
                        </div>
                        <div class="card-body">
                    ...
                    <?php }else{?>
                        ...
                        <div class="alert alert-info">
                            <h3> Silahlan Login Terlebih Dahulu!</h3>
                            <hr/>
