...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2222524213ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_uts&table=tbl_user">`db_uts`.`tbl_user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_uts&table=barang">`db_uts`.`barang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_uts&table=tbl_barang">`db_uts`.`tbl_barang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_uts&table=kendaraan">`db_uts`.`kendaraan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dborder&table=barang">`dborder`.`barang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_uts&table=user">`db_uts`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud3&table=kendaraan">`crud3`.`kendaraan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud3&table=user">`crud3`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dborder&table=tborderdetail">`dborder`.`tborderdetail`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dborder&table=user">`dborder`.`user`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="636770715c213e7770506a716926526e">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="dborder" targettable="barang">
            ...
            Waktu eksekusi kueri
                            ...
                            targetdb="db_uts" targettable="barang">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">CREATE TABLE `db_uts`.`barang` ( `id` INT NOT NULL ,  `nama` VARCHAR(40) NULL DEFAULT NULL ,  `hrg` DOUBLE NULL DEFAULT NULL ,  `jml` INT NULL DEFAULT NULL ,  `keterangan` VARCHAR(100) NOT NULL ,  `foto` VARCHAR(200) NOT NULL ) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="dborder" targettable="barang">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">INSERT INTO `barang` (`id`, `nama`, `hrg`, `jml`, `keterangan`, `foto`) VALUES (&#039;1&#039;, &#039;Asus TUF F15&#039;, &#039;15000000&#039;, &#039;10&#039;, &#039;Mahal&#039;, &#039;Nanti&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_uts" targettable="barang">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `barang`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_uts" targettable="kendaraan">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `kendaraan`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_uts" targettable="tbl_barang">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_barang`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="db_uts" targettable="barang">
                            <div class="action_content">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `barang`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="db_uts" targettable="tbl_user">
                            <div class="action_content">
                    <span class="action collapse">
            Tampilkan
                    </span>
